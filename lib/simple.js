...
END:VCARD
        ...
        reply: {
            ...
            value(jid, text = '', quoted, options) {
                return Buffer.isBuffer(text) ? conn.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { ...options, text }, { quoted, ephemeralExpiration: '86400', ...options })
            }
        },
        sendButton: {
            /**
...
/**
    ...
    */
    ...
    conn.reply = (jid, text = '', quoted, options) => {
      return client.sendMessage(jid, { ...options, text }, { quoted, ephemeralExpiration: '86400', ...options })
    }
