...
sock.sendMessage(id, { text: 'oh hello there' }, { quoted: message })

//////////////////////////////////////

// send a mentions message
sock.sendMessage(id, { text: '@12345678901', mentions: ['12345678901@s.whatsapp.net'] })
...
// send a link
sock.sendMessage(id, { text: 'Hi, this was sent using https://github.com/FERDIZ-afk/Baileys' })
...
// implement this on your end
const msg = getMessageFromStore('455@s.whatsapp.net', 'HSJHJWH7323HSJSJ')

// WA forward the message!
sock.sendMessage('1234@s.whatsapp.net', { forward: msg })
...
const key = {
    ...
    id: 'AHASHH123123AHGA',
    // id of the message you want to read
    
    participant: '912121232@s.whatsapp.net'
    // the ID of the user that sent the  message (undefined for individual chats)
}
...
sock.sendPresenceUpdate('available', id) 
/*
...
**Note**
In the multi-device version of WhatsApp
if a desktop client is active, WA doesn't send push notifications to the device.
If you would like to receive said notifications,
mark your Baileys client offline using
